...
3. Click the **Folder** button to create a new folder for this project (suggested name: **rna-seq-tutorial**).
...
In this expanded view the left sidebar menu:
     ...
     **(A)** shows several icons: Home presents the default view at login with access to recently used and favorite applications;
...
Learn more in the |Discovery Environment Guide| and |Learning Center|
